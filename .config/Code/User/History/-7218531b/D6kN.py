...
Python CLI program that mathematically compare 2 sets of molecular structures, based on their atomic coordinates, throughout the Root-Mean-Square Deviation, and, Kabsch algorithm. If you are interested in the source code, you can find it on my [*Github*](https://https://github.com/m-rauen/Coordinates_Analyzer)
