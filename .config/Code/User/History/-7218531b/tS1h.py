...
Python CLI program that mathematically compare 2 sets of the *same* molecular structures, based on their atomic coordinates, throughout the Root-Mean-Square Deviation, and, Kabsch algorithm. Writing more text just to test the soft_wrap.\n
"""
