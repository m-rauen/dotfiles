...
def inputFiles(fname1, fname2, rmsd, kabsch, full): 
    ...
    By default the program runs the full calculation, i.e. RMSD + Kabsch algorithm, this means that if you dindn't add any option to the callout, then, it will run the full calculation. However, you can specify the type of calculation using the options.
