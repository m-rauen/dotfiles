...
def inputFiles(fname1, fname2, rmsd, kabsch, full): 
    ...
    By default the program runs the full calculation, i.e. RMSD + Kabsch algorithm, this means that  option,  however, you can specify the type of calculation using the options.
